...
namespace SpreadsheetTests
{
    ...
    public class SpreadsheetTests
    {
        ...
        {
            using (StreamWriter writer = new System.IO.StreamWriter("save2.txt"))
            {
